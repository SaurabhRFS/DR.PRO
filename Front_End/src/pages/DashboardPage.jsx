...
const DashboardPage = () => {
  ...
  // FIX: Use normal state instead of useLocalStorage
  ...
  const fetchData = useCallback(async () => {
    setIsLoading(true);
    try {
      // FIX: Fetch Profile, Appointments, and Patients all at once
...
//   // Simplified Profile State (Ensures it works without local storage hooks)
...
//                 <Avatar className="h-12 w-12 cursor-pointer border-2 border-primary/50 shadow-md">
//                   <AvatarImage
//                     src={doctorProfile.avatarUrl || `https://avatar.vercel.sh/${doctorProfile.name}.png?size=48`}
//                     alt={doctorProfile.name}
//                   />
//                   <AvatarFallback className="bg-primary/20 text-primary font-semibold">
//                     {getInitials(doctorProfile.name)}
...
//               <Button
//                 variant="outline"
//                 className={`w-full justify-start py-6 text-left border-2 dark:border-slate-700 transition-colors duration-200 ${link.hoverClasses}`}
//               >
//                 <link.icon className={`mr-3 h-5 w-5 ${link.color}`} />
//                 <div>
//                   <p className="font-semibold text-foreground">{link.name}</p>
...
//           <CardDescription>A quick look at who is visiting today.</CardDescription>
//         </CardHeader>
//         <CardContent>
//           {isLoading ? (
//             <motion.div
...
//               className="text-center py-8 text-muted-foreground dark:text-slate-400"
//             >
//               <ClockIcon size={32} className="mx-auto mb-3 text-primary/70 animate-spin" />
//               <p>Loading today's appointments...</p>
//             </motion.div>
//           ) : todaysAppointments.length > 0 ? (
//             <ul className="space-y-3">
...
//                       </p>
//                     </div>
//                     <Link to={`/appointments?id=${app.id}`}>
//                       <Button
//                         variant="ghost"
//                         size="sm"
//                         className="text-primary hover:text-primary/80"
